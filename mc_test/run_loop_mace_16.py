...
if __name__ == '__main__':
    ...
    output_xyzfile = f"/home/wansc/icemc/mc_tests/update_stru/ice_n_[211]_valid_unopt_{timestamp}.xyz"

    time_equilibration = 200
    time_sample = 200
    output_file = f"/home/wansc/icemc/mc_tests/ice_n_[211]_unopt_en_{time_sample}_{timestamp}.txt"
