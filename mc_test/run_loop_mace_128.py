...
def write_energy_data(T_range, energies, sigmas, accept_ratios, output_file):
    with open(output_file, "w") as f:
        # 写入第一行注释
        f.write("# T_range energies sigmas accept_ratio\n")
...
if __name__ == '__main__':
    ...
    hbond_file = "/home/wansc/icemc/stru_origin/ice_n_[422]_hbonds.txt"
    valid_file = "/home/wansc/icemc/stru_valid/ice_n_[422]_valid.txt"
    ...
    stru_base_file = "/home/wansc/icemc/stru_origin/ice_n_[422]_stru.vasp"
    output_xyzfile = f"/home/wansc/icemc/mc_tests/update_stru/ice_n_[422]_valid_unopt_{timestamp}.xyz"

    time_equilibration = 200
    time_sample = 200
    output_file = f"/home/wansc/icemc/mc_tests/ice_n_[422]_unopt_en_{time_sample}_{timestamp}.txt"
    print(f"there will be {time_sample*mace_batch_size} samples")

    T_range = np.sort(np.append(np.linspace(50, 100, 1), 10))
